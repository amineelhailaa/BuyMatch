    ...
    <header class="sticky top-0 z-50 border-b border-white/5 bg-zinc-950/70 backdrop-blur">
        <div class="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
            ...
            <nav class="hidden items-center gap-8 text-sm text-zinc-300 md:flex">
                <a class="hover:text-white transition" href="matches_page.php">Home</a>
                <a class="hover:text-white transition" href="matches_page.php">Matches</a>
                <a class="inline-flex items-center gap-2 text-white" href="login.php">
